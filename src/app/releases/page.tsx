...
async function getRecapData(pagina: number) {
  ...
  if (error || countError) {
    console.error("Erro ao buscar lançamentos:", error || countError);
    notFound();
  }
    ...
    <div className="mx-auto max-w-7xl p-4 md:p-8">
      <div className="lg:col-span-2">
        <h2 className="mb-4 border-b-2 border-red-700 pb-2 text-xl font-bold uppercase">
          Todos os Lançamentos da Semana
        </h2>
